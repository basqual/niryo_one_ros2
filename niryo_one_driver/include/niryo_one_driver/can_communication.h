...
#include "niryo_one_driver/hardware_parameters.h"
...
class CanCommunication {
    ...
    public:
        ...
        CanCommunication();
        int init(int hardware_version,rclcpp::Node::SharedPtr node);
    ...
    private:
        ...
        //std::vector<long> required_steppers_ids;
        //std::vector<long> allowed_steppers_ids;
