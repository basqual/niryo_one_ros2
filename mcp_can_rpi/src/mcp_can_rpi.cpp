...
bool MCP_CAN::setupInterruptGpio()
{
    ...
    if (!result) {
        RCLCPP_INFO(rclcpp::get_logger("MCP_CAN"),"Gpio started\n");
    }
    else {
        RCLCPP_INFO(rclcpp::get_logger("MCP_CAN"),"Gpio startup fail\n");
        return false;
    }
    ...
    return true;
#else
    RCLCPP_INFO(rclcpp::get_logger("MCP_CAN"),"Can't use GPIO on non-ARM processor");
    return false;
#endif
}
...
bool MCP_CAN::setupSpi()
{
    ...
    RCLCPP_INFO(rclcpp::get_logger("MCP_CAN"),"Started SPI : %d\n", result_spi);
    if (result_spi < 0) {
        return false;
    }
    nanosleep((const struct timespec[]){{0, 500000L}}, NULL);
    return true;
#else
    RCLCPP_INFO(rclcpp::get_logger("MCP_CAN"),"Can't use SPI on non-ARM processor");
    return false;
#endif
}
...
void MCP_CAN::mcp2515_reset(void)                                      
{
    ...
    std::this_thread::sleep_for(std::chrono::nanoseconds(10000L));
...
INT8U MCP_CAN::mcp2515_init(const INT8U canIDMode, const INT8U canSpeed, const INT8U canClock)
{
  ...
  INT8U res;
    ...
    {
#if DEBUG_MODE
      RCLCPP_INFO(rclcpp::get_logger("MCP_CAN"),"Entering Configuration Mode Failure...\r\n"); 
#endif
      return res;
    }
#if DEBUG_MODE
    RCLCPP_INFO(rclcpp::get_logger("MCP_CAN"),"Entering Configuration Mode Successful!\r\n");
#endif
    ...
    {
#if DEBUG_MODE
      RCLCPP_INFO(rclcpp::get_logger("MCP_CAN"),"Setting Baudrate Failure...\r\n");
#endif
      return res;
    }
#if DEBUG_MODE
    RCLCPP_INFO(rclcpp::get_logger("MCP_CAN"),"Setting Baudrate Successful!\r\n");
#endif
...
*/
            ...
            default:
#if DEBUG_MODE        
            RCLCPP_INFO(rclcpp::get_logger("MCP_CAN"),"`Setting ID Mode Failure...\r\n");
#endif           
            return MCP2515_FAIL;
            break;
}    
        ...
        {
#if DEBUG_MODE        
          RCLCPP_INFO(rclcpp::get_logger("MCP_CAN"),"Returning to Previous Mode Failure...\r\n");
#endif           
          return res;
        }
...
INT8U MCP_CAN::init_Mask(INT8U num, INT8U ext, INT32U ulData)
{
...
#if DEBUG_MODE
    RCLCPP_INFO(rclcpp::get_logger("MCP_CAN"),"Starting to Set Mask!\r\n");
#endif
    res = mcp2515_setCANCTRL_Mode(MODE_CONFIG);
    if(res > 0){
#if DEBUG_MODE
  ...
  return res;
    ...
    if(res > 0){
#if DEBUG_MODE
    RCLCPP_INFO(rclcpp::get_logger("MCP_CAN"),"Entering Previous Mode Failure...\r\nSetting Mask Failure...\r\n"); 
#endif
    return res;
  }
#if DEBUG_MODE
    RCLCPP_INFO(rclcpp::get_logger("MCP_CAN"),"Setting Mask Successful!\r\n");
#endif
    return res;
}
...
INT8U MCP_CAN::init_Filt(INT8U num, INT8U ext, INT32U ulData)
{
    INT8U res = MCP2515_OK;
#if DEBUG_MODE
    RCLCPP_INFO(rclcpp::get_logger("MCP_CAN"),"Starting to Set Filter!\r\n");
#endif
    res = mcp2515_setCANCTRL_Mode(MODE_CONFIG);
    if(res > 0)
    {
#if DEBUG_MODE
      RCLCPP_INFO(rclcpp::get_logger("MCP_CAN"),"Enter Configuration Mode Failure...\r\n"); 
#endif
      return res;
    }
...
#if DEBUG_MODE
    RCLCPP_INFO(rclcpp::get_logger("MCP_CAN"),"Setting Filter Successfull!\r\n");
#endif
